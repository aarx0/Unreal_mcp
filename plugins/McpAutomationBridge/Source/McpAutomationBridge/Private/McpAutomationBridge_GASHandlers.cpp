...
// GAS Member Handlers
// =============================================================================
// Dispatch lives in the manage_gas FMcpCall classes
// (Private/MCP/Calls/McpCalls_ManageGas.cpp); each HandleGas*
...
bool UMcpAutomationBridgeSubsystem::HandleGasConfigureCueTrigger(
    const FString& RequestId,
    const TSharedPtr<FJsonObject>& Payload,
    FMcpResponseHandle Socket)
{
    ...
    SendAutomationResponse(Socket, RequestId, true, TEXT("Cue trigger configuration variables added"), Result);
    return true;
#endif // WITH_EDITOR && MCP_HAS_GAS
}
...
// ============================================================
// 13.6 ABILITY SET ACTIONS (2 actions)
// ============================================================
