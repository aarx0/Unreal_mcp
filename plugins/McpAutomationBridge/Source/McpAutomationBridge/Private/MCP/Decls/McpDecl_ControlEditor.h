...
inline const FMcpParamDecl P_ControlEditor_4[] = { { TEXT("actorName"), EMcpParamKind::String, false }, { TEXT("objectPath"), EMcpParamKind::String, false }, { TEXT("location"), EMcpParamKind::Object, false }, { TEXT("rotation"), EMcpParamKind::Object, false }, { TEXT("viewMode"), EMcpParamKind::String, false }, { TEXT("fov"), EMcpParamKind::Number, false }, { TEXT("speed"), EMcpParamKind::Number, false }, { TEXT("assetPath"), EMcpParamKind::String, true }, { TEXT("filename"), EMcpParamKind::String, false }, { TEXT("maxWidth"), EMcpParamKind::Number, false }, { TEXT("name"), EMcpParamKind::String, false }, { TEXT("index"), EMcpParamKind::Number, false }, { TEXT("id"), EMcpParamKind::Number, false }, { TEXT("category"), EMcpParamKind::String, false }, { TEXT("preferences"), EMcpParamKind::Object, false }, { TEXT("realtime"), EMcpParamKind::Bool, false }, { TEXT("type"), EMcpParamKind::String, false }, { TEXT("inputType"), EMcpParamKind::String, false }, { TEXT("inputAction"), EMcpParamKind::String, false }, { TEXT("key"), EMcpParamKind::String, false }, { TEXT("x"), EMcpParamKind::Number, false }, { TEXT("y"), EMcpParamKind::Number, false }, { TEXT("button"), EMcpParamKind::String, false }, { TEXT("value"), EMcpParamKind::Number, false }, { TEXT("route"), EMcpParamKind::String, false }, { TEXT("mode"), EMcpParamKind::String, true }, { TEXT("enabled"), EMcpParamKind::Bool, false }, { TEXT("deltaTime"), EMcpParamKind::Number, false }, { TEXT("levelPath"), EMcpParamKind::String, false }, { TEXT("path"), EMcpParamKind::String, false } };
...
inline const FMcpParamDecl P_ControlEditor_32[] = { { TEXT("direction"), EMcpParamKind::String, false }, { TEXT("device"), EMcpParamKind::String, false }, { TEXT("key"), EMcpParamKind::String, false }, { TEXT("stabilizeFocus"), EMcpParamKind::Bool, false }, { TEXT("assetPath"), EMcpParamKind::Any, false } };
inline const FMcpParamDecl P_ControlEditor_33[] = { { TEXT("actorName"), EMcpParamKind::String, false }, { TEXT("objectPath"), EMcpParamKind::String, false }, { TEXT("location"), EMcpParamKind::Object, false }, { TEXT("rotation"), EMcpParamKind::Object, false }, { TEXT("viewMode"), EMcpParamKind::String, false }, { TEXT("fov"), EMcpParamKind::Number, false }, { TEXT("speed"), EMcpParamKind::Number, false }, { TEXT("assetPath"), EMcpParamKind::String, true }, { TEXT("filename"), EMcpParamKind::String, false }, { TEXT("maxWidth"), EMcpParamKind::Number, false }, { TEXT("name"), EMcpParamKind::String, false }, { TEXT("index"), EMcpParamKind::Number, false }, { TEXT("id"), EMcpParamKind::Number, false }, { TEXT("category"), EMcpParamKind::String, false }, { TEXT("preferences"), EMcpParamKind::Object, false }, { TEXT("realtime"), EMcpParamKind::Bool, false }, { TEXT("type"), EMcpParamKind::String, false }, { TEXT("inputType"), EMcpParamKind::String, false }, { TEXT("inputAction"), EMcpParamKind::String, false }, { TEXT("key"), EMcpParamKind::String, false }, { TEXT("x"), EMcpParamKind::Number, false }, { TEXT("y"), EMcpParamKind::Number, false }, { TEXT("button"), EMcpParamKind::String, false }, { TEXT("value"), EMcpParamKind::Number, false }, { TEXT("route"), EMcpParamKind::String, false }, { TEXT("mode"), EMcpParamKind::String, true }, { TEXT("enabled"), EMcpParamKind::Bool, false }, { TEXT("deltaTime"), EMcpParamKind::Number, false }, { TEXT("levelPath"), EMcpParamKind::String, false }, { TEXT("path"), EMcpParamKind::String, false } };
...
inline const FMcpCallDecl GControlEditor[] =
{
	...
	{ TEXT("control_editor"), TEXT("eject"), {}, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("execute_command"), P_ControlEditor_4, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("focus_actor"), P_ControlEditor_5, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("hide_stats"), {}, EMcpCallFlags::None },
	...
	{ TEXT("control_editor"), TEXT("pause"), {}, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("play"), {}, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("possess"), P_ControlEditor_12, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("redo"), {}, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("resume"), {}, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("save_all"), {}, EMcpCallFlags::None },
	...
	{ TEXT("control_editor"), TEXT("show_stats"), {}, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("simulate_input"), P_ControlEditor_31, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("simulate_nav"), P_ControlEditor_32, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("single_frame_step"), P_ControlEditor_33, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("start_recording"), P_ControlEditor_34, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("step_frame"), {}, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("stop"), {}, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("stop_recording"), {}, EMcpCallFlags::None },
	{ TEXT("control_editor"), TEXT("undo"), {}, EMcpCallFlags::None },
};
}
