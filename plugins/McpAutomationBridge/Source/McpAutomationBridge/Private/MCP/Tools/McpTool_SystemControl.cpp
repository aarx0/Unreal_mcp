...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		return FMcpSchemaBuilder()
			...
			.String(TEXT("target"), TEXT("run_ubt: build target (e.g. MyProjectEditor). Non-blocking: returns a buildId immediately; poll get_build_status."))
			...
			.String(TEXT("buildId"), TEXT("get_build_status: buildId from run_ubt (default: most recent build this session). Returns status running|succeeded|failed, [N/M] progress, parsed errors, warningCount, resultLine, logPath."))
