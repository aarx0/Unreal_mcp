...
static void S_FindByTag(FMcpSchemaBuilder& B)
{
	B.String(TEXT("tag"), TEXT("find_by_tag: tag key to match (set_tags metadata or asset-registry tag)."))
	 .String(TEXT("path"), TEXT("Path to a directory."))
	 .Integer(TEXT("maxResults"), TEXT("find_by_tag: result cap (default 100, max 1000)."))
...
static void S_CreateNoiseTexture(FMcpSchemaBuilder& B)
{
	B.String(TEXT("name"), TEXT("Name identifier."))
	 ...
	 .Integer(TEXT("seed"), TEXT("create_noise_texture: noise seed (default 0)."))
...
static void S_CreateAoFromMesh(FMcpSchemaBuilder& B)
{
	B.String(TEXT("meshPath"), TEXT("Mesh asset path."))
	 ...
	 .Integer(TEXT("uvChannel"), TEXT("create_ao_from_mesh: source UV channel index (default 0)."))
	 .Bool(TEXT("save"), TEXT("Save the asset(s) after the operation."))
...
static void S_ResizeTexture(FMcpSchemaBuilder& B)
{
	B.String(TEXT("sourcePath"), TEXT("Source path for import/duplicate/rename/move (assetPath also accepted)."))
	 .String(TEXT("name"), TEXT("Name identifier."))
	 .String(TEXT("path"), TEXT("Path to a directory."))
	 .Integer(TEXT("newWidth"), TEXT("resize_texture: output width in pixels (default 512)."))
	 .Integer(TEXT("newHeight"), TEXT("resize_texture: output height in pixels (default 512)."))
...
{
	B.String(TEXT("assetPath"), TEXT("Asset path (e.g., /Game/Path/Asset)."))
	 .Integer(TEXT("lodBias"), TEXT("set_lod_bias: additional texture LOD bias (default 0)."))
	 .Bool(TEXT("save"), TEXT("Save the asset(s) after the operation."))
	 .Required({TEXT("assetPath")});
}
...
static void S_ConfigureVirtualTexture(FMcpSchemaBuilder& B)
{
	B.String(TEXT("assetPath"), TEXT("Asset path (e.g., /Game/Path/Asset)."))
	 ...
	 .Integer(TEXT("tileSize"), TEXT("configure_virtual_texture: VT tile size (default 128)."))
	 .Integer(TEXT("tileBorderSize"), TEXT("configure_virtual_texture: VT tile border size (default 4)."))
	 .Bool(TEXT("save"), TEXT("Save the asset(s) after the operation."))
	 .Required({TEXT("assetPath")});
}
...
{                                                                                        \
	...
	bool Run(UMcpAutomationBridgeSubsystem& S, const FString& RequestId,                 \
	         const TSharedPtr<FJsonObject>& Payload, FMcpResponseHandle Socket) override \
	{                                                                                    \
		return HandlerFn(S, RequestId, TEXT(ActionLiteral), Payload, Socket);            \
	}                                                                                    \
};

// Core (AssetWorkflow / AssetQuery members)
MCP_MA_CALL(List, "list", McpHandlers::Asset::HandleListAssets, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(Import, "import", McpHandlers::Asset::HandleImportAsset, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(Duplicate, "duplicate", McpHandlers::Asset::HandleDuplicateAsset, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(Rename, "rename", McpHandlers::Asset::HandleRenameAsset, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(Move, "move", McpHandlers::Asset::HandleRenameAsset, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(Delete, "delete", McpHandlers::Asset::HandleDeleteAssets, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(CreateFolder, "create_folder", McpHandlers::Asset::HandleCreateFolder, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(SearchAssets, "search_assets", McpHandlers::Asset::HandleSearchAssets, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(GetDependencies, "get_dependencies", McpHandlers::Asset::HandleGetDependencies, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(GetReferencers, "get_referencers", McpHandlers::Asset::HandleGetReferencers, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(GetAssetProperties, "get_asset_properties", McpHandlers::Asset::HandleGetAssetProperties, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(SetAssetProperty, "set_asset_property", McpHandlers::Asset::HandleSetAssetProperty, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(GetSourceControlState, "get_source_control_state", McpHandlers::Asset::HandleGetSourceControlState, EMcpCallFlags::RequiresEditor)
MCP_MA_ACTION_CALL(AnalyzeGraph, "analyze_graph", McpHandlers::Asset::HandleAnalyzeGraph, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(GetAssetGraph, "get_asset_graph", McpHandlers::Asset::HandleGetAssetGraph, EMcpCallFlags::RequiresEditor)
MCP_MA_ACTION_CALL(CreateThumbnail, "create_thumbnail", McpHandlers::Asset::HandleGenerateThumbnail, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(SetTags, "set_tags", McpHandlers::Asset::HandleSetTags, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(GetMetadata, "get_metadata", McpHandlers::Asset::HandleGetMetadata, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(SetMetadata, "set_metadata", McpHandlers::Asset::HandleSetMetadata, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(Validate, "validate", McpHandlers::Asset::HandleValidateAsset, EMcpCallFlags::RequiresEditor)
MCP_MA_ACTION_CALL(FixupRedirectors, "fixup_redirectors", McpHandlers::Asset::HandleFixupRedirectors, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(FindByTag, "find_by_tag", McpHandlers::Asset::HandleFindByTag, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(GenerateReport, "generate_report", McpHandlers::Asset::HandleGenerateReport, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(CreateDataTable, "create_data_table", McpHandlers::Asset::HandleCreateDataTable, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddDataTableRow, "add_data_table_row", McpHandlers::Asset::HandleDataTableRowOp, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(EditDataTableRow, "edit_data_table_row", McpHandlers::Asset::HandleDataTableRowOp, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(RemoveDataTableRow, "remove_data_table_row", McpHandlers::Asset::HandleDataTableRowOp, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(GetDataTableRows, "get_data_table_rows", McpHandlers::Asset::HandleDataTableRowOp, EMcpCallFlags::RequiresEditor)
MCP_MA_ACTION_CALL(ImportDataTable, "import_data_table", McpHandlers::Asset::HandleDataTableRowOp, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(CreateRenderTarget, "create_render_target", McpHandlers::Asset::HandleTextureCreateRenderTarget, EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(GenerateLods, "generate_lods", McpHandlers::Asset::HandleGenerateLODs, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(AddMaterialParameter, "add_material_parameter", McpHandlers::Asset::HandleAddMaterialParameter, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(ListInstances, "list_instances", McpHandlers::Asset::HandleListMaterialInstances, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(ResetInstanceParameters, "reset_instance_parameters", McpHandlers::Asset::HandleResetInstanceParameters, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(Exists, "exists", McpHandlers::Asset::HandleDoesAssetExist, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(GetMaterialStats, "get_material_stats", McpHandlers::Asset::HandleGetMaterialStats, EMcpCallFlags::RequiresEditor)
MCP_MA_ACTION_CALL(NaniteRebuildMesh, "nanite_rebuild_mesh", McpHandlers::Asset::HandleNaniteRebuildMesh, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(BulkRename, "bulk_rename", McpHandlers::Asset::HandleBulkRenameAssets, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(BulkDelete, "bulk_delete", McpHandlers::Asset::HandleBulkDeleteAssets, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(SourceControlCheckout, "source_control_checkout", McpHandlers::Asset::HandleSourceControlCheckout, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(SourceControlSubmit, "source_control_submit", McpHandlers::Asset::HandleSourceControlSubmit, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(Save, "save", McpHandlers::Asset::HandleSaveAsset, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(SaveAll, "save_all", McpHandlers::ControlEditor::HandleControlEditorSaveAll, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)

// Material authoring (MaterialAuthoringHandlers.cpp)
MCP_MA_CALL(CreateMaterial, "create_material", McpHandlers::Asset::HandleMaterialCreateMaterial, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(SetBlendMode, "set_blend_mode", McpHandlers::Asset::HandleMaterialSetBlendMode, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(SetShadingModel, "set_shading_model", McpHandlers::Asset::HandleMaterialSetShadingModel, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(SetMaterialDomain, "set_material_domain", McpHandlers::Asset::HandleMaterialSetMaterialDomain, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(AddTextureSample, "add_texture_sample", McpHandlers::Asset::HandleMaterialAddTextureSample, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(AddTextureCoordinate, "add_texture_coordinate", McpHandlers::Asset::HandleMaterialAddTextureCoordinate, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(AddScalarParameter, "add_scalar_parameter", McpHandlers::Asset::HandleMaterialAddScalarParameter, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(AddVectorParameter, "add_vector_parameter", McpHandlers::Asset::HandleMaterialAddVectorParameter, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(AddStaticSwitchParameter, "add_static_switch_parameter", McpHandlers::Asset::HandleMaterialAddStaticSwitchParameter, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(AddMathNode, "add_math_node", McpHandlers::Asset::HandleMaterialAddMathNode, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddWorldPosition, "add_world_position", McpHandlers::Asset::HandleMaterialAddSimpleExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddVertexNormal, "add_vertex_normal", McpHandlers::Asset::HandleMaterialAddSimpleExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddPixelDepth, "add_pixel_depth", McpHandlers::Asset::HandleMaterialAddSimpleExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddFresnel, "add_fresnel", McpHandlers::Asset::HandleMaterialAddSimpleExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddReflectionVector, "add_reflection_vector", McpHandlers::Asset::HandleMaterialAddSimpleExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddPanner, "add_panner", McpHandlers::Asset::HandleMaterialAddSimpleExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddRotator, "add_rotator", McpHandlers::Asset::HandleMaterialAddSimpleExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddNoise, "add_noise", McpHandlers::Asset::HandleMaterialAddSimpleExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddVoronoi, "add_voronoi", McpHandlers::Asset::HandleMaterialAddSimpleExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddIf, "add_if", McpHandlers::Asset::HandleMaterialAddConditional, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddSwitch, "add_switch", McpHandlers::Asset::HandleMaterialAddConditional, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(AddCustomExpression, "add_custom_expression", McpHandlers::Asset::HandleMaterialAddCustomExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(ConnectNodes, "connect_nodes", McpHandlers::Asset::HandleMaterialConnectNodes, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(DisconnectNodes, "disconnect_nodes", McpHandlers::Asset::HandleMaterialDisconnectNodes, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(CreateMaterialFunction, "create_material_function", McpHandlers::Asset::HandleMaterialCreateMaterialFunction, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddFunctionInput, "add_function_input", McpHandlers::Asset::HandleMaterialAddFunctionIO, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(AddFunctionOutput, "add_function_output", McpHandlers::Asset::HandleMaterialAddFunctionIO, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(UseMaterialFunction, "use_material_function", McpHandlers::Asset::HandleMaterialUseMaterialFunction, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(GetMaterialFunctionInfo, "get_material_function_info", McpHandlers::Asset::HandleMaterialGetMaterialFunctionInfo, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(CreateMaterialInstance, "create_material_instance", McpHandlers::Asset::HandleMaterialCreateMaterialInstance, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(SetScalarParameterValue, "set_scalar_parameter_value", McpHandlers::Asset::HandleMaterialSetScalarParameterValue, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(SetVectorParameterValue, "set_vector_parameter_value", McpHandlers::Asset::HandleMaterialSetVectorParameterValue, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(SetTextureParameterValue, "set_texture_parameter_value", McpHandlers::Asset::HandleMaterialSetTextureParameterValue, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(CreateLandscapeMaterial, "create_landscape_material", McpHandlers::Asset::HandleMaterialCreateSpecialMaterial, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(CreateDecalMaterial, "create_decal_material", McpHandlers::Asset::HandleMaterialCreateSpecialMaterial, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_ACTION_CALL(CreatePostProcessMaterial, "create_post_process_material", McpHandlers::Asset::HandleMaterialCreateSpecialMaterial, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(AddLandscapeLayer, "add_landscape_layer", McpHandlers::Asset::HandleMaterialAddLandscapeLayer, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(ConfigureLayerBlend, "configure_layer_blend", McpHandlers::Asset::HandleMaterialConfigureLayerBlend, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(CompileMaterial, "compile_material", McpHandlers::Asset::HandleMaterialCompileMaterial, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(GetMaterialInfo, "get_material_info", McpHandlers::Asset::HandleMaterialGetMaterialInfo, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(FindNode, "find_node", McpHandlers::Asset::HandleMaterialFindNode, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(GetNodeConnections, "get_node_connections", McpHandlers::Asset::HandleMaterialGetNodeConnections, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(GetNodeProperties, "get_node_properties", McpHandlers::Asset::HandleMaterialGetNodeProperties, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(SetNodeValue, "set_node_value", McpHandlers::Asset::HandleMaterialSetNodeValue, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(SetStaticSwitchParameterValue, "set_static_switch_parameter_value", McpHandlers::Asset::HandleMaterialSetStaticSwitchParameterValue, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(DeleteNode, "delete_node", McpHandlers::Asset::HandleMaterialDeleteNode, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(UpdateCustomExpression, "update_custom_expression", McpHandlers::Asset::HandleMaterialUpdateCustomExpression, EMcpCallFlags::RequiresEditor | EMcpCallFlags::Mutating)
MCP_MA_CALL(GetNodeChain, "get_node_chain", McpHandlers::Asset::HandleMaterialGetNodeChain, EMcpCallFlags::RequiresEditor)
MCP_MA_CALL(GetConnectedSubgraph, "get_connected_subgraph", McpHandlers::Asset::HandleMaterialGetConnectedSubgraph, EMcpCallFlags::RequiresEditor)
...
MCP_MA_CALL(CreateNoiseTexture, "create_noise_texture", McpHandlers::Asset::HandleTextureCreateNoiseTexture, EMcpCallFlags::Mutating)
MCP_MA_CALL(CreateGradientTexture, "create_gradient_texture", McpHandlers::Asset::HandleTextureCreateGradientTexture, EMcpCallFlags::Mutating)
MCP_MA_CALL(CreatePatternTexture, "create_pattern_texture", McpHandlers::Asset::HandleTextureCreatePatternTexture, EMcpCallFlags::Mutating)
MCP_MA_CALL(CreateNormalFromHeight, "create_normal_from_height", McpHandlers::Asset::HandleTextureCreateNormalFromHeight, EMcpCallFlags::Mutating)
MCP_MA_CALL(CreateAoFromMesh, "create_ao_from_mesh", McpHandlers::Asset::HandleTextureCreateAoFromMesh, EMcpCallFlags::Mutating)
MCP_MA_CALL(ResizeTexture, "resize_texture", McpHandlers::Asset::HandleTextureResizeTexture, EMcpCallFlags::Mutating)
MCP_MA_CALL(AdjustLevels, "adjust_levels", McpHandlers::Asset::HandleTextureAdjustLevels, EMcpCallFlags::Mutating)
MCP_MA_CALL(AdjustCurves, "adjust_curves", McpHandlers::Asset::HandleTextureAdjustCurves, EMcpCallFlags::Mutating)
MCP_MA_CALL(Blur, "blur", McpHandlers::Asset::HandleTextureBlur, EMcpCallFlags::Mutating)
MCP_MA_CALL(Sharpen, "sharpen", McpHandlers::Asset::HandleTextureSharpen, EMcpCallFlags::Mutating)
MCP_MA_CALL(Invert, "invert", McpHandlers::Asset::HandleTextureInvert, EMcpCallFlags::Mutating)
MCP_MA_CALL(Desaturate, "desaturate", McpHandlers::Asset::HandleTextureDesaturate, EMcpCallFlags::Mutating)
MCP_MA_CALL(ChannelPack, "channel_pack", McpHandlers::Asset::HandleTextureChannelPack, EMcpCallFlags::Mutating)
MCP_MA_CALL(ChannelExtract, "channel_extract", McpHandlers::Asset::HandleTextureChannelExtract, EMcpCallFlags::Mutating)
MCP_MA_CALL(CombineTextures, "combine_textures", McpHandlers::Asset::HandleTextureCombineTextures, EMcpCallFlags::Mutating)
MCP_MA_CALL(SetCompressionSettings, "set_compression_settings", McpHandlers::Asset::HandleTextureSetCompressionSettings, EMcpCallFlags::Mutating)
MCP_MA_CALL(SetTextureGroup, "set_texture_group", McpHandlers::Asset::HandleTextureSetTextureGroup, EMcpCallFlags::Mutating)
MCP_MA_CALL(SetLodBias, "set_lod_bias", McpHandlers::Asset::HandleTextureSetLodBias, EMcpCallFlags::Mutating)
MCP_MA_CALL(ConfigureVirtualTexture, "configure_virtual_texture", McpHandlers::Asset::HandleTextureConfigureVirtualTexture, EMcpCallFlags::Mutating)
MCP_MA_CALL(SetStreamingPriority, "set_streaming_priority", McpHandlers::Asset::HandleTextureSetStreamingPriority, EMcpCallFlags::Mutating)
MCP_MA_CALL(GetTextureInfo, "get_texture_info", McpHandlers::Asset::HandleTextureGetTextureInfo, EMcpCallFlags::None)
