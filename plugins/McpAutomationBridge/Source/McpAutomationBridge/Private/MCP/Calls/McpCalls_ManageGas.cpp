...
static void S_SetModifierMagnitude(FMcpSchemaBuilder& B)
{
	B.String(TEXT("name"), TEXT("Name of the asset to create."))
	 ...
	 .String(TEXT("cuePath"), TEXT("Path to Gameplay Cue asset (alias for blueprintPath)."))
	 .String(TEXT("assetPath"), TEXT("Asset path (e.g., /Game/Path/Asset)."))
	 .Integer(TEXT("modifierIndex"), TEXT("set_modifier_magnitude: index into the effect's Modifiers array (0-based)."))
...
static void S_SetEffectStacking(FMcpSchemaBuilder& B)
{
	B.String(TEXT("name"), TEXT("Name of the asset to create."))
	 ...
	 .Integer(TEXT("stackLimit"), TEXT("set_effect_stacking: alias for stackLimitCount (checked first)."))
	 .Integer(TEXT("stackLimitCount"), TEXT("Maximum stack count."))
