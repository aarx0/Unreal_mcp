...
bool UMcpAutomationBridgeSubsystem::HandleInventoryConfigureEvents(
    const FString& RequestId, const TSharedPtr<FJsonObject>& Payload,
    FMcpResponseHandle Socket) {
  FString BlueprintPath = GetPayloadString(Payload, TEXT("blueprintPath"));
...
bool UMcpAutomationBridgeSubsystem::HandleInventoryDefineEquipmentSlots(
    const FString& RequestId, const TSharedPtr<FJsonObject>& Payload,
    FMcpResponseHandle Socket) {
  FString BlueprintPath = GetPayloadString(Payload, TEXT("blueprintPath"));
...
bool UMcpAutomationBridgeSubsystem::HandleInventoryConfigureStationRecipes(
    const FString& RequestId, const TSharedPtr<FJsonObject>& Payload,
    FMcpResponseHandle Socket) {
